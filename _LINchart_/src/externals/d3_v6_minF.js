...
!function(t, n) {
    ...
    function Sa() {}
    var Ea = [[], [[[1, 1.5], [.5, 1]]], [[[1.5, 1], [1, 1.5]]], [[[1.5, 1], [.5, 1]]], [[[1, 0.5], [1.5, 1]]], [[[1, 1.5], [.5, 1]], [[1, 0.5], [1.5, 1]]], [[[1, 0.5], [1, 1.5]]], [[[1, 0.5], [.5, 1]]], [[[.5, 1], [1, 0.5]]], [[[1, 1.5], [1, 0.5]]], [[[.5, 1], [1, 0.5]], [[1.5, 1], [1, 1.5]]], [[[1.5, 1], [1, 0.5]]], [[[.5, 1], [1.5, 1]]], [[[1, 1.5], [1.5, 1]]], [[[.5, 1], [1, 1.5]]], []];
    function ka() {
        var t = 1
          , n = 1
          , e = I
            ...
            function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                ...
                if (b > 4 * n && g--) {
                    var m = a + h
                      ...
                      , C = k - i
                      , P = _ * N - v * C;
                    (P * P / b > n || Ec((v * N + _ * C) / b - 0.5) > .3 || a * h + u * d + c * p < sh) && (e(r, i, o, a, u, c, E, k, T, m /= M, x /= M, w, g, y),
                    y.point(E, k),
    ...
    function gh(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, g = 0, y = 0, v = 0, _ = 0, b = 0, m = 1, x = 1, w = null, M = Ps, A = null, T = fl, S = 0.5;
        function E(t) {
        ...
        function r(t, r) {
            ...
            return function() {
                do {
                    ...
                    u *= u * u;
                    var c = 1 - n()
                } while (c >= 1 - .0331 * t * t * t * t && Math.log(c) >= 0.5 * t * t + i * (1 - u + Math.log(u)));
                return i * u * a() * r
            }
        }
        return r.source = t,
      ...
      , Kd = function t(n) {
        ...
        function i(t, n) {
            ...
            (n = +n) >= 1 ? ()=>t : n <= 0 ? ()=>0 : function() {
                ...
                for (var f = a < 0.5, s = e(f ? a : 1 - a), l = s(), h = 0; l <= o; ++h)
                    l += s();
                return i + (f ? h : o - h)
            }
        }
    ...
    function up() {
        var t, n, e = ap().unknown(void 0), r = e.domain, i = e.range, o = 0, a = 1, u = !1, c = 0, f = 0, s = 0.5;
        function l() {
            var e = r().length
              , l = a < o
              , h = l ? a : o
    ...
    function kv() {
        ...
        function f(n) {
            return null == n || isNaN(n = +n) ? i : u(0 === e ? 0.5 : (n = (r(n) - t) * e,
    ...
    function Pv() {
        var t, n, e, r, i, o, a, u = 0, c = 0.5, f = 1, s = 1, l = lp, h = !1;
        function d(t) {
            return isNaN(t = +t) ? a : (t = 0.5 + ((t = +o(t)) - n) * (s * t < s * n ? r : i),
    ...
    t.pack = function() {
        ...
        function i(i) {
            return i.x = n / 2,
            i.y = e / 2,
            t ? i.eachBefore(gd(t)).eachAfter(yd(r, 0.5)).eachBefore(vd(1)) : i.eachBefore(gd(pd)).eachAfter(yd(hd, 1)).eachAfter(yd(r, i.r / Math.min(n, e))).eachBefore(vd(Math.min(n, e) / (2 * i.r))),
            i
        }
